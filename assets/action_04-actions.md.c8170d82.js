...
<span class="token punctuation">]</span>
</code></pre></div><h2 id="cancel-action" tabindex="-1">Cancel Action <a class="header-anchor" href="#cancel-action" aria-hidden="true">#</a></h2><p>Action can be interrupted by returning a special object &quot;CancelledAct&quot;. This will stop the chain of events if you build it using <code>watch</code> or <code>emit</code>.</p><div class="language-ts"><pre><code><span class="token comment">// cancel-action.ts</span>
...
</code></pre></div><h2 id="watch" tabindex="-1">Watch <a class="header-anchor" href="#watch" aria-hidden="true">#</a></h2><p>You can launch the action after another one through the &quot;watch&quot; property.</p><p>Any of the actions in <code>watch</code>, after execution, will call the current action.</p><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>Be careful. The action should not follow itself. Otherwise it will start an endless loop.</p></div><div class="language-ts"><pre><code><span class="token comment">// Action queue</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> ActMasterAction <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue-act-master&#39;</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">SecondAction</span> <span class="token keyword">implements</span> <span class="token class-name">ActMasterAction</span> <span class="token punctuation">{</span>
  ...
  watch<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&#39;FirstAction&#39;</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
...
<span class="token keyword">const</span> di <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token string-property property">&#39;api&#39;</span><span class="token operator">:</span> SuperAPI
<span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">WithDiAction</span> <span class="token keyword">implements</span> <span class="token class-name">ActMasterAction</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="emit-another-action-in-action" tabindex="-1">Emit another Action in Action <a class="header-anchor" href="#emit-another-action-in-action" aria-hidden="true">#</a></h2><p>If you need to call another action inside the current one, you can do it using the <code>emit</code> handler.</p><p>It can be connected via the decorator or via the helper.</p><p>This way you can build chains of actions that can be stopped by <code>CancelledAct</code>.</p><p>You can use this to <a href="./../advanced/08-emit-many-results.html">return different values</a> to subscribers.</p><div class="language-ts"><pre><code><span class="token comment">// with-emit-action.ts</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">WithEmitAction</span> <span class="token keyword">implements</span> <span class="token class-name">ActMasterAction</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div>`,71),e=[o];function c(l,i,u,k,r,d){return a(),s("div",null,e)}var g=n(p,[["render",c]]);export{h as __pageData,g as default};
