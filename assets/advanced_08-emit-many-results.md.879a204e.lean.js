import{_ as n,c as s,o as a,a as t}from"./app.7370f633.js";const h='{"title":"Pass many results from one action","description":"","frontmatter":{},"relativePath":"advanced/08-emit-many-results.md","lastUpdated":1639131624688}',p={},e=t(`__VP_STATIC_START__<h1 id="pass-many-results-from-one-action" tabindex="-1">Pass many results from one action <a class="header-anchor" href="#pass-many-results-from-one-action" aria-hidden="true">#</a></h1><p>When running queries, there are situations where you need to change the value of the result several times.</p><p>For example, we subscribe to the result of a query. And we expect an array of values. But during the query process, we have to clear the previous state.</p><div class="language-html"><pre><code>// App.vue
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">WithEmitAction</span> <span class="token keyword">implements</span> <span class="token class-name">ActMasterAction</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>__VP_STATIC_END__`,7),o=[e];function c(u,i,l,k,r,m){return a(),s("div",null,o)}var f=n(p,[["render",c]]);export{h as __pageData,f as default};
