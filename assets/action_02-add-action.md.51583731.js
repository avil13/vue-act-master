import{_ as n,c as a,o as s,a as t}from"./app.6da51a5e.js";const m='{"title":"Add Actions to Vue-act-master","description":"","frontmatter":{},"relativePath":"action/02-add-action.md","lastUpdated":1634596289405}',p={},o=t(`<h1 id="add-actions-to-vue-act-master" tabindex="-1">Add Actions to Vue-act-master <a class="header-anchor" href="#add-actions-to-vue-act-master" aria-hidden="true">#</a></h1><p><div class="table-of-contents"><ul></ul></div></p><p>You can add actions in different ways.</p><p>Suppose you have a variable with an array of actions:</p><div class="language-ts"><pre><code><span class="token comment">// actions: ActMasterAction[]</span>
