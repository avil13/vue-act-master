import{_ as n,c as s,o as a,a as t}from"./app.f3d8cd10.js";const h='{"title":"Advanced unsubscribe","description":"","frontmatter":{},"headers":[{"level":2,"title":"subsList","slug":"subslist"}],"relativePath":"advanced/06-subsList.md","lastUpdated":1634771919436}',p={},o=t(`<h1 id="advanced-unsubscribe" tabindex="-1">Advanced unsubscribe <a class="header-anchor" href="#advanced-unsubscribe" aria-hidden="true">#</a></h1><h2 id="subslist" tabindex="-1">subsList <a class="header-anchor" href="#subslist" aria-hidden="true">#</a></h2><p>In the process, you often have to remember the subscriptions you need to unsubscribe from in order to avoid memory leaks.</p><p>In order not to store unnecessary variables for unsubscribes, you can use the <code>subList</code> property.</p><h4 id="example" tabindex="-1">Example: <a class="header-anchor" href="#example" aria-hidden="true">#</a></h4><div class="language-ts"><pre><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>call <code>$act.subsList.add</code> - must be called immediately after subscribing, because only the last unsubscribe function is stored</p></div>`,15),c=[o];function e(u,i,l,k,r,d){return a(),s("div",null,c)}var y=n(p,[["render",e]]);export{h as __pageData,y as default};
