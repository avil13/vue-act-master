import{_ as n,c as a,o as s,a as t}from"./app.2a3f081e.js";const m='{"title":"Instalation","description":"","frontmatter":{},"headers":[{"level":2,"title":"Vanilla installation","slug":"vanilla-installation"},{"level":2,"title":"Vue installation","slug":"vue-installation"},{"level":2,"title":"Constructor properties (ActMasterOptions)","slug":"constructor-properties-actmasteroptions"},{"level":2,"title":"Nuxt.JS","slug":"nuxt-js"}],"relativePath":"action/01-installation.md","lastUpdated":1648975299916}',e={},o=t(`<h1 id="instalation" tabindex="-1">Instalation <a class="header-anchor" href="#instalation" aria-hidden="true">#</a></h1><p><div class="table-of-contents"><ul><li><a href="#vanilla-installation">Vanilla installation</a></li><li><a href="#vue-installation">Vue installation</a></li><li><a href="#constructor-properties-actmasteroptions">Constructor properties (ActMasterOptions)</a></li><li><a href="#nuxt-js">Nuxt.JS</a></li></ul></div></p><p>Start by creating a project.</p><h2 id="vanilla-installation" tabindex="-1">Vanilla installation <a class="header-anchor" href="#vanilla-installation" aria-hidden="true">#</a></h2><p>Then add a act-master.</p><div class="language-bash"><pre><code><span class="token function">yarn</span> <span class="token function">add</span> act-master
</code></pre></div><p>Create instance</p><div class="language-ts"><pre><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ActMaster <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;act-master&#39;</span><span class="token punctuation">;</span>
...
<span class="token keyword">const</span> $act <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ActMaster</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  actions
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="vue-installation" tabindex="-1">Vue installation <a class="header-anchor" href="#vue-installation" aria-hidden="true">#</a></h2><p>Then add a vue-act-master.</p><div class="language-bash"><pre><code><span class="token function">yarn</span> <span class="token function">add</span> vue-act-master
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">modules</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&#39;vue-act-master/nuxt&#39;</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token literal-property property">modules</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&#39;vue-act-master/nuxt&#39;</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
  <span class="token literal-property property">actMaster</span><span class="token operator">:</span> <span class="token punctuation">{</span> <span class="token comment">// config for Vue-Act-Master</span>
