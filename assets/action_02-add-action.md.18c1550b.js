import{_ as n,c as s,o as a,a as t}from"./app.2a3f081e.js";const m='{"title":"Add Actions to Vue-act-master","description":"","frontmatter":{},"headers":[{"level":2,"title":"With helpers","slug":"with-helpers"}],"relativePath":"action/02-add-action.md","lastUpdated":1648975299916}',p={},o=t(`<h1 id="add-actions-to-vue-act-master" tabindex="-1">Add Actions to Vue-act-master <a class="header-anchor" href="#add-actions-to-vue-act-master" aria-hidden="true">#</a></h1><p><div class="table-of-contents"><ul><li><a href="#with-helpers">With helpers</a></li></ul></div></p><p>You can add actions in different ways.</p><p>Suppose you have a variable with an array of actions:</p><div class="language-ts"><pre><code><span class="token comment">// actions: ActMasterAction[]</span>
...
</code></pre></div>`,11),c=[o];function e(u,i,l,k,r,d){return a(),s("div",null,c)}var _=n(p,[["render",e]]);export{m as __pageData,_ as default};
